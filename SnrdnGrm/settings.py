"""
Django settings for SnrdnGrm project.
...
SECRET_KEY = "django-insecure-s^4(rwkjkui0oh!(hacivuyi%-bqqgpp10q!z_9((u9^03u2)t"
...
WSGI_APPLICATION = "SnrdnGrm.wsgi.application"
